window.onload = function () {
    ...
    let productos = '' // PARA GUARDAR EL RESULTADO DE CADA ITERACIÓN, Y LUEGO PASARLE AL innerHTML
    ...
    .then(function(res){
        if (res.status == 200){
            ...
            for (let i = 0 ; i < 8 ; i ++){ //RECORRO LOS PRIMEROS 8
                ...
                productos += producto // GUARDO EL HTML CREADO EN ESTA ITERACIÓN

            }

            ultimosEnVista.innerHTML = productos // PASO EL RESULTADO FINAL AL HTML
